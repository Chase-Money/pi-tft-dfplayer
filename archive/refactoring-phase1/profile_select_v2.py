...
def select_hardware(profile: str) -> Tuple[str, str]:
    ...
    Using dotted paths keeps this module import-light and easy to test. The
    caller can import dynamically based on these paths.
    """
    ...
    # Default to touchscreen framebuffer path
    return (
